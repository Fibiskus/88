...
namespace ConsoleApp3
{
    ...
    public class Product_range
    {
        ...
        public void Remove()
        {
            ...
            while (n > count - 1 || n < 1)
            {
                Console.WriteLine("Ви ввели некоректний номер день, введiть ще раз: ");
                n = is_number(Console.ReadLine());
            }
        ...
        public void Output()
        {
            ...
            {
                Console.WriteLine("\nВведiть день, який ви хочете вивести: ");
                int n = is_number(Console.ReadLine());
                while (n > count - 1 || n < 1)
                {
                    Console.WriteLine("Ви ввели некоректний номер дня, введiть ще раз: ");
                    n = is_number(Console.ReadLine());
                }
                string s = s0[n];
                Console.WriteLine("\nДні:\t\tПонеділок:\t\tВівторк:\t\tСереда:\t\t\tЧетвер:\t\t\t\tЧетвер:\n" + s);
            }
            Console.WriteLine("\n");
        }
